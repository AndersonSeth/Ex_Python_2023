...
@app.route("/<float:a>/mais/<float:b>")
@app.route("/<float(signed=True):a>/mais/<float(signed=True):b>")
@app.route("/<int(signed = True):a>/mais/<float(signed = True):b>")
@app.route("/<float(signed = True):a>/mais/<int(signed = True):b>")
@app.route("/<int(signed = True):a>/mais/<int(signed = True):b>")
def somar(a, b):
    return str(a + b)
